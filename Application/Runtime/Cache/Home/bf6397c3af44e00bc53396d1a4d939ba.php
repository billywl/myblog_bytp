...
<div class="ibody">
  ...
  <article>
		...
		<?php if(is_array($pros)): $i = 0; $__LIST__ = $pros;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$p): $mod = ($i % 2 );++$i;?><a href="[field:typelink/]"><?php echo ($p["pro_name"]); ?> |</a><?php endforeach; endif; else: echo "" ;endif; ?>
		</div>
	...
	<div class="bloglist">
        ...
        <ul>
          ...
          <p><?php echo ($a["art_description"]); ?><a href="[field:arcurl/]" target="_blank" class="readmore">全文</a></p>
...
<div class="pagination"><?php echo ($show); ?></div>
    ...
    <div class="ph_news">
      ...
      <ul class="ph_n">
      <?php if(is_array($a1)): $i = 0; $__LIST__ = $a1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$a1): $mod = ($i % 2 );++$i;?><li><span class="num<?php echo ($i); ?>"><?php echo ($i); ?></span><a href="[field:arcurl/]"><?php echo ($a1["art_title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
      </ul>
      <h2>
        <p>文章推荐</p>
      </h2>
      <ul>
      <?php if(is_array($a2)): $i = 0; $__LIST__ = $a2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$a2): $mod = ($i % 2 );++$i;?><li><span class="num<?php echo ($i); ?>"><?php echo ($i); ?></span><a href="[field:arcurl/]"><?php echo ($a2["art_title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
      </ul>
	      <div class="links">
      <h2>
        <p>友情链接</p>
